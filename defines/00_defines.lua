...
NGame = {
	...
	LAG_DAYS_FOR_PAUSE = 18,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 0.8, 0.3, 0.15, 0.07, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDiplomacy = {
	...
	AUTONOMY_LEVEL_CHANGE_PP_COST_BASE = 25.0,		-- Base cost of changing level of autonomy
	AUTONOMY_LEVEL_CHANGE_PP_ANNEX = 150,			-- Annexation cost
	AUTONOMY_LEVEL_CHANGE_PP_FREE = 150,			-- Break free cost
...
NCountry = {
	EVENT_PROCESS_OFFSET = 30,						-- Events are checked every X day per country or state (1 is ideal, but CPU heavy)
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 28,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 32,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	BASE_DIVISION_SUPPORT_SLOT_COST = 4, 	--Base cost to unlock a support slot
...
NRailwayGun = {
	RAILWAY_GUN_RANGE = 32,							-- The range of railway guns in pixels
...
NIndustrialOrganisation = {
	...
	DESIGN_TEAM_CHANGE_XP_COST = 1,								-- Flat cost added to the XP cost of a new equipment design. If 0, cost is entirely disabled.
